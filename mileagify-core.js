...
mileagifyJS.map = function(){
    ...
    var render = function(selector, location) {
        ...
        // Create the map
        mileagifyJS.map.object = new google.maps.Map($(selector)[0], options);
...
mileagifyJS.route = function(){
    ...
    var getFuelStat = function(distance_km)
    {
        // 5 l/100km avg consumption
        return (distance_km*mileagifyJS.config.avg_consumption/100).toFixed(2);
    };
    ...
    var getCO2Stat = function(fuel_l)
    {
        ...
        // 2.6 diesel / 2.4 petrol = 2.5 average
    ...
    var showDirections = function(domElement) {
        this.directionsDisplay.setPanel(domElement);
    };
